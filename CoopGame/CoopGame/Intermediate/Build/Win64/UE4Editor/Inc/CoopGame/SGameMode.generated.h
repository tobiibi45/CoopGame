...
#define CoopGame_Source_CoopGame_Public_SGameMode_h_22_PRIVATE_PROPERTY_OFFSET \
	FORCEINLINE static uint32 __PPO__TimerBetweenWaves() { return STRUCT_OFFSET(ASGameMode, TimerBetweenWaves); } \
	FORCEINLINE static uint32 __PPO__CurrentGameType() { return STRUCT_OFFSET(ASGameMode, CurrentGameType); } \
	FORCEINLINE static uint32 __PPO__bIsHardModeActive() { return STRUCT_OFFSET(ASGameMode, bIsHardModeActive); }
...
#define FOREACH_ENUM_GAMEMODETYPE(op) \
	op(TimeBased) \
	op(DeathBased) 
PRAGMA_ENABLE_DEPRECATION_WARNINGS
